...
type BadgedColor = "#43b581" | "#faa61a" | (string & {})
const getBadgeStyles = (color: BadgedColor) => {
  switch (color) {
    case "#43b581":
      return "bg-green-600/10 text-green-500 ring-green-600/20"

    case "#faa61a":
      return "bg-yellow-600/10 text-yellow-500 ring-yellow-600/20"
    default:
      return "bg-gray-600/10 text-gray-500 ring-gray-600/20"
  }
}
        ...
        <div className="bg-[#2f3136] text-sm w-full rounded p-3 mb-4 mt-1.5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
            {badgeText ? (
              <span
                className={cn(
                  "inline-flex order-2 items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-insect",
